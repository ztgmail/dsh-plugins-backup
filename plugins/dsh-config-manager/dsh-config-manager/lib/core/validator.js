 ...
 */
import { validateManifest } from "../schema/manifest.js";
import { validateSectionData } from "../schema/config.js";
import { canImport, describeVersion } from "../schema/versions.js";
export { validateManifest } from "../schema/manifest.js";
export { validateSectionData } from "../schema/config.js";
...
/** 兼容性得分的可读描述（UI 报告用） */
export function describeCompatibility(score) {
    switch (score) {
...
export function describeSchemaStatus(schemaVersion) {
