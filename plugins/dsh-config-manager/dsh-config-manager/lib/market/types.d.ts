...
export declare const MARKET_INDEX_SCHEMA_VERSION = 1;
/** items/<id>/manifest.json schema 版本（本版恒 1） */
export declare const MARKET_ITEM_SCHEMA_VERSION = 1;
/**
 ...
 */
export declare const MAX_MARKET_ZIP_BYTES: number;
/**
 ...
 */
export declare const BANNED_MARKET_SECTIONS: readonly SectionId[];
/**
 * itemId / 仓库 url-hash 的安全字符集（防路径穿越 + 用作目录名）：
 * 字母数字开头，仅 . _ -，最长 128。与 sync GitTransport 的 SAFE_ID_RE 同构。
 */
export declare const SAFE_ITEM_ID_RE: RegExp;
/** 校验 itemId 是否合法；不合法抛错（防 items/<id>/ 越界）。 */
export declare function assertSafeItemId(id: string): void;
