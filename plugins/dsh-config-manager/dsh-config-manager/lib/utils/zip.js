...
import { isPathSafe, isSameOrChild } from "./paths.js";
import { atomicWriteFile } from "./atomic-write.js";
export const DEFAULT_ZIP_SAFETY_LIMITS = {
    maxEntries: 10_000,
...
export class ZipArchive {
    ...
    readEntry(name) {
        ...
        if (!meta)
            throw new ZipSafetyError(`ZIP 中不存在条目: ${name}`);
        if (meta.isDirectory)
...
export function parseZip(buf, limits = {}) {
 ...
 */
export async function safeExtract(zipPath, destDir, limits = {}) {
