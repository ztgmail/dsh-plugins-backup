...
export declare function inspectSections(analysis: ImportAnalysis, plan: ImportPlan): BackupInspectSection[];
/** 从计划构建差异摘要（与导入预览统计口径一致）。 */
export declare function inspectSummary(analysis: ImportAnalysis, plan: ImportPlan): BackupInspectSummary;
 ...
 */
export declare function groupPlanItems(items: readonly PlanItem[]): InspectChangeGroup[];
/** 备份 diff 分组入口：从差异摘要取 changes 数组分组（与配置档案预览共用语义）。 */
export declare function inspectGroupedChanges(summary: BackupInspectSummary): InspectChangeGroup[];
