...
export declare function restartRequiredItems(plan: ImportPlan): {
    id: string;
    adapter: SectionId;
    description: string;
}[];
...
export declare function unresolvedItems(result: ImportResult): {
    id: string;
    status: 'failed' | 'skipped';
    message?: string;
}[];
/** 聚合收尾清单：plan（待重启项）+ result（补录凭据 / 失败跳过项）。 */
export declare function importNextSteps(plan: ImportPlan, result: ImportResult): ImportNextSteps;
