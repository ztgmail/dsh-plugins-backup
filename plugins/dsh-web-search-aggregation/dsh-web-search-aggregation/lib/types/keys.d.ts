 ...
 */
export declare function parseApiKeys(value: string): string[];
/**
 ...
 */
export declare function formatApiKeys(keys: readonly string[]): string;
/**
 ...
 */
export declare function keyRefLabel(ref: string, index: number, total: number): string;
/** How many leading characters a masked tag shows. */
export declare const KEY_HEAD_CHARS = 12;
/** How many trailing characters a masked tag shows. */
export declare const KEY_TAIL_CHARS = 2;
/**
